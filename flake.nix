{
  ...
  outputs =
    ...
    let
      ...
      mkFmt =
        ...
        let
          ...
          # Format via stdout + cmp so re-runs are idempotent.
          ...
          # .list / .conf: strip leading+trailing whitespace per line (no indent on rules)
    ...
    in
    {
      ...
      # optional: nix develop  (same tools on PATH for debugging formatters)
