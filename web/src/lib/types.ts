...
export const FEATURED_GROUPS = [
  {
    id: "ai",
    name: "AI",
    description: "Apple Intelligence、Claude、Copilot、Gemini、OpenAI 与 xAI",
    categories: [
      "apple-intelligence",
      "anthropic",
      "github-copilot",
  ...
  },
  {
    id: "google",
    name: "Google",
    description: "Google 服务及其 IP 地址段",
    categories: ["google"],
  },
  {
    id: "apple",
    name: "Apple",
    description: "Apple 服务与 Apple Push 自定义补充规则",
    categories: ["apple", "apple-push"],
  },
  {
    id: "telegram",
    name: "Telegram",
    description: "Telegram 域名及 IP 地址段",
    categories: ["telegram"],
  },
  {
    id: "twitter",
    name: "Twitter",
    description: "X（Twitter）域名及 IP 地址段",
    categories: ["twitter"],
  },
  {
    id: "ip-attribution",
    name: "IP Attribution",
    description: "按拦截、直连、代理顺序处理 IP 归属检测",
