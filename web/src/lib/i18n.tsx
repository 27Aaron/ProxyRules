...
const zh = {
  ...
  "toast.groupsUpdated": "策略组已更新：新增 {added} 个，移除 {removed} 个",
  ...
  "search.heading": "管理策略组",
  "search.help": "勾选要保留或新增的规则；取消勾选可移除此前添加的策略组。",
  ...
  "search.results": "规则分类 · 共 {count} 个",
  "search.kindFilter": "规则类型",
  "search.kindAll": "全部",
  "search.kindColumn": "类型",
  "search.rulesColumn": "规则数",
  "search.categoryCount": "{count} 个分类",
  "search.selectVisible": "选择当前结果",
  "search.selectRule": "选择 {name}",
  "search.ruleCount": "{count} 条",
  "search.changeSummary": "将添加 {added} 个，移除 {removed} 个",
  "search.noChanges": "当前没有待保存的更改",
  "search.resetChanges": "重置更改",
  "search.cancel": "取消",
  "search.saveChanges": "保存更改",
  "search.included": "已包含",
  "search.added": "已添加",
  "kind.domain": "域名",
  "kind.ip": "IP",
...
const en: Record<Key, string> = {
  ...
  "toast.groupsUpdated":
    "Policy groups updated: {added} added, {removed} removed",
  ...
  "region.Home": "Home",
  "region.Other": "Other",
  "group.ai": "Mainstream AI platforms and model services",
  ...
  "group.ip-attribution":
    "IP geolocation routing for selected Chinese platforms",
  ...
  "search.heading": "Manage policy groups",
  "search.help":
    "Keep or add checked rules. Uncheck a group you previously added to remove it.",
  ...
  "search.results": "Rule categories · {count} total",
  "search.kindFilter": "Rule type",
  "search.kindAll": "All",
  "search.kindColumn": "Type",
  "search.rulesColumn": "Rules",
  "search.categoryCount": "{count} categories",
  "search.selectVisible": "Select current results",
  "search.selectRule": "Select {name}",
  "search.ruleCount": "{count} rules",
  "search.changeSummary": "{added} to add, {removed} to remove",
  "search.noChanges": "No unsaved changes",
  "search.resetChanges": "Reset changes",
  "search.cancel": "Cancel",
  "search.saveChanges": "Save changes",
...
const ja: Record<Key, string> = {
  ...
  "search.heading": "ポリシーグループを管理",
  "search.help":
    "保持または追加するルールを選択します。以前追加したグループは選択を外すと削除できます。",
  ...
  "search.results": "ルールカテゴリ · 全 {count} 件",
  "search.kindFilter": "ルール種別",
  "search.kindAll": "すべて",
  "search.kindColumn": "種別",
  "search.rulesColumn": "ルール数",
  "search.categoryCount": "{count} カテゴリ",
  "search.selectVisible": "現在の結果を選択",
  "search.selectRule": "{name} を選択",
  "search.ruleCount": "{count} 件",
  "search.changeSummary": "{added} 件を追加、{removed} 件を削除",
  "search.noChanges": "保存していない変更はありません",
  "search.resetChanges": "変更をリセット",
  "search.cancel": "キャンセル",
  "search.saveChanges": "変更を保存",
...
const ru: Record<Key, string> = {
  ...
  "step.groups.search": "Другие правила",
  ...
  "region.GBR": "Великобритания",
  "region.DEU": "Германия",
  "region.MAC": "Макао",
  "region.Home": "Домой",
  "region.Other": "Другие",
  "group.ai": "Популярные ИИ-платформы и сервисы моделей",
  ...
  "group.ip-attribution": "Маршрутизация IP-геолокации для китайских платформ",
  ...
  "search.heading": "Управление группами",
  "search.help":
    "Отметьте правила, которые нужно сохранить или добавить. Снимите отметку с ранее добавленной группы, чтобы удалить её.",
  ...
  "search.results": "Категории правил · всего {count}",
  "search.kindFilter": "Тип правил",
  "search.kindAll": "Все",
  "search.kindColumn": "Тип",
  "search.rulesColumn": "Правила",
  "search.categoryCount": "Категорий: {count}",
  "search.selectVisible": "Выбрать текущие результаты",
  "search.selectRule": "Выбрать {name}",
  "search.ruleCount": "Правил: {count}",
  "search.changeSummary": "Добавить: {added}, удалить: {removed}",
  "search.noChanges": "Нет несохранённых изменений",
  "search.resetChanges": "Сбросить изменения",
  "search.cancel": "Отмена",
  "search.saveChanges": "Сохранить изменения",
