    ...
    <Tabs defaultValue="network" className="gap-4">
      <TabsList variant="line" className="w-full">
        ...
        <TabsTrigger value="client">
          {t("settings.client", { client: clientLabel })}
        </TabsTrigger>
      </TabsList>

      <TabsContent value="network" className="mt-1">
        <div className="flex flex-col gap-5">
          <SettingsSection
            title={t("settings.resources")}
            description={t("settings.resourcesDescription")}
          >
            <FieldGroup>
              <ValidatedField
          ...
          <SettingsSection
            ...
            description={t("settings.dnsDescription", {
              client: clientLabel,
            })}
          >
            <FieldGroup>
          ...
          <SettingsSection
            ...
            description={t("settings.connectivityDescription", {
              client: clientLabel,
            })}
          >
            <FieldGroup>
      ...
      <TabsContent value="rules" className="mt-1">
        <SettingsSection
          title={t("settings.builtin")}
          description={`${t("settings.builtinDescription")} ${t(
      ...
      <TabsContent value="client" className="mt-1">
        <div className="flex flex-col gap-5">
          {state.client !== "shadowrocket" ? (
            <>
              <SettingsSection
                title={t("settings.nodeSource")}
                description={t("settings.nodeSourceDescription", {
                  client: clientLabel,
                })}
              >
                <FieldGroup>
          ...
          <SettingsSection
            ...
            description={t("settings.healthCheckDescription")}
          >
            <FieldGroup>
              <ValidatedField
          ...
          <SettingsSection
            title={t("settings.clientBehavior")}
            description={t("settings.clientBehaviorDescription", {
              client: clientLabel,
            })}
          >
            <FieldGroup>
                      ...
                      onValueChange={(value) =>
                        updateSettings((settings) => ({
                          ...
                          surge: {
                            ...settings.surge,
                            logLevel:
                              value as GeneralSettings["surge"]["logLevel"],
                          },
                        }))
                      }
                    >
